                ...
                <Accordion>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        {' '}
                        Technothon 2024 will be conducted in an offline format.
                        The event will be hosted offline at V.E.S. Polytechnic
                        College.
                      </p>
                      <p>
                        {' '}
                  ...
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        {' '}
                        Technothon 2024 is organized by Vivekanand Education
                        Society&apos;s Polytechnic in association with VESP
                        Alumni Association and IIC Cell.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        {' '}
                        No, there are no registration fees. You just need to
                        come with your innovation; your accommodation and food
                        during the 24-hours are all on us.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      ...
                      <p>
                        {' '}
                        The team should be of four members and should include a
                        minimum of one female member.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      ...
                      <p>
                        We would be happy to provide food and accommodation
                  ...
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        {' '}
                        Yes, all the participants get an E-Participation
                        Certificate along with learning experience to compete in
                        a hackathon.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        {' '}
                        Blind Bet Registration is a unique process where teams
                        register without knowing the specific problem
                        statements. Teams registered during this period get
                        preference in the shortlisting process. Find out more in
                        the “PROBLEM STATEMENTS” section.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    ...
                    <Accordion.Content>
                      <p>
                        Form your team. Only the team leader needs to fill the
                        Blind Bet Registration Form. A unique Team ID will be
                        sent to the team leader&apos;s email.{' '}
                      </p>
                      <p>
                        Use the Team ID to submit your idea during the Idea
                        Submission phase after problem statements are revealed
                        in January. Get preference over your competitors by
                        participating in Blind Bet Registration.
                      </p>
                    </Accordion.Content>
                  </Accordion.Panel>
                  <Accordion.Panel>
                    <Accordion.Title>
                      Does Blind Bet Registration guarantee shortlistment for
                      the finale?
                    </Accordion.Title>
                    <Accordion.Content>
                      <p>
                        {' '}
                        No, Blind Bet Registration does not guarantee
                        shortlistment for the finale but increases the
